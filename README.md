...
*   `uv` (or `pip`) installed for dependency management

### Steps

1.  **Install Dependencies**:
    Navigate to the root directory of the project in your terminal and install the project dependencies. This project uses `uv` for dependency management.
